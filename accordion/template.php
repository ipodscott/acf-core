 ...
 */
	...
	?>
<div class="acc-head <?php echo $className; ?> <?php if( $active_state ): ?>active <?php endif; ?>" id="<?php echo $id; ?>" <?php echo $attributes; ?>>
...
<div class="acc-body <?php if( $active_state ): ?>active <?php endif; ?>" <?php echo $attributes; ?>><?php echo '<InnerBlocks />';?></div>