...
// Created Block Attributes
	acf_register_block(array(
	'name'				=> 'presentation_gallery',
	'title'				=> __('Presentation Gallery'),
	'description'		=> __('Block for creating a presentation gallery.'),
	'render_template'   => plugin_dir_path( __FILE__ ) . 'presentation_template.php',
	'post_types'        => array('presentation'),
	'mode'              => 'preview',
	'category'			=> 'acf-core-blocks',
	'multiple'          =>  false,
	'icon'				=> '<svg viewBox="0 0 24 24"><path d="M21.4,1.6H2.6c-1.2,0-2.1,0.9-2.1,2.1v12.5c0,1.1,0.9,2.1,2.1,2.1h7.3v2.1H7.8v2.1h8.3v-2.1h-2v-2.1h1.8h5.5
		c1.2,0,2.1-0.9,2.1-2.1V3.7C23.5,2.5,22.6,1.6,21.4,1.6z M21.4,16.2h-5.2H2.6V3.7h18.8V16.2z"/><polygon points="9.4,13.7 12,11.9 14.6,13.7 13.6,10.7 16.2,8.9 13,8.9 12,5.7 11,8.9 7.8,8.9 10.4,10.7 "/></svg>',
	'keywords'			=> array( 'columns' ),
	'enqueue_style'     =>  plugin_dir_url( __FILE__ ). 'css/preso_styles.css',
    'enqueue_script'    =>  plugin_dir_url( __FILE__ ). 'js/preso_scripts.js', array('jquery'), '1.0', true,
...
// Our custom post type function for presentations
function create_posttype_presentations() {
...
add_action( 'init', 'create_posttype_presentations' );
